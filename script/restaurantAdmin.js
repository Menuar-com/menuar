...
$(document).ready(function(){
  ...
  function s1GetData() {
    ...
    $.post('online/restaurantAdmin/resGetData/stage1.html',
           {'ssCode' : '3H98Ci11i2tE'},
           function(data) {
      /* post -- get data.. */
      if (data) {
    ...
    $.post('online/restaurantAdmin/resGetData/stage3.html', {'ssCode' : '3H98Ci11i2tE'}, function(data) {
      if (data) {
        ...
        $.each(jsonData.type, function(key1, value1) {
          ...
          /* #tim# for use in manage tool's popup menu */
          RMan.update_ft_mapper(stage3formNumber + 1, value1.s3FormID);
        ...
        muResAdminStagesHeight();
        /* #tim#: to set focus on the first row.
         * seems that resulting effect is not good enough...
         */
        $($('#mu-res-admin-stage3 .mu-stage3-form  input')[0]).trigger('click');
      }
    });
  }
